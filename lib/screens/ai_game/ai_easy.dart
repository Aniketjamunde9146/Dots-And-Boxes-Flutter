...
class AiEasyGame extends StatefulWidget {
  const AiEasyGame({super.key});

  @override
  State<AiEasyGame> createState() => _AiEasyGameState();
}

class _AiEasyGameState extends State<AiEasyGame>
