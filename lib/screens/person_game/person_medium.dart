...
class PersonMediumGame extends StatefulWidget {
  const PersonMediumGame({super.key});

  @override
  State<PersonMediumGame> createState() => _PersonMediumGameState();
}

class _PersonMediumGameState extends State<PersonMediumGame>
