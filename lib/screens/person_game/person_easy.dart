...
class PersonEasyGame extends StatefulWidget {
  const PersonEasyGame({super.key});

  @override
  State<PersonEasyGame> createState() => _PersonEasyGameState();
}

class _PersonEasyGameState extends State<PersonEasyGame>
